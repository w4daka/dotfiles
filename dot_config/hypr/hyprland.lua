...
------------------
---- MONITORS ----
---要確認:`hyprctl monitor`で実際の名前を確認すべし
------------------
...
hl.on("hyprland.start", function()
	hl.exec_cmd("copyq & hyprpaper & hypridle &waybar & mako")
...
hl.config({
	input = {
		...
		touchdevice = {
			transform = 0,
			output = "ven_04f3:00-04f3:32eb-touchpad",
			enabled = false,
		},
	},
})
...
hl.device({
	name = "ven_04f3:00-04f3:32eb-touchpad",
	enabled = false,
})
...
hl.bind(mainMod .. " + i", hl.dsp.exec_cmd(" ~/.config/hypr/ime.sh"))
